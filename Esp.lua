...
local function isBodyPart(name)
	return find(name, "Head") or find(name, "Torso") or find(name, "Leg") or find(name, "Arm");
end
...
function EspObject:Update()
	...
	local head = self.enabled and not interface.whitelist[self.player] and findFirstChild(self.character, "TPVBodyVanillaHead");
...
function EspInterface.isFriendly(player)
	return player and player:FindFirstChild("friendly_marker") or nil;
end

function EspInterface.getCharacter(player)
	return player and player:FindFirstChild("HumanoidRootPart") and player or nil;
end
...
-- Need to optimize as it's causing lag
